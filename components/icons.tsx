...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 4L4,24L24,44L44,24L24,4Z" fill="#059669" stroke="#065f46" strokeWidth="2" strokeLinejoin="round"/>
    <path d="M24 4L34,14L24,24L14,14L24,4Z" fill="#d1fae5"/>
    <path d="M34,14L44,24L34,34L24,24L34,14Z" fill="#a7f3d0"/>
    <path d="M24,44L14,34L24,24L34,34L24,44Z" fill="#6ee7b7"/>
    <path d="M14,14L4,24L14,34L24,24L14,14Z" fill="#a7f3d0"/>
  </svg>
);
...
export const LanguageIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m5 8 6 6" /><path d="m4 14 6-6 2-3" /><path d="M2 5h12" /><path d="m7 2 5 5" /><path d="m12 18 6-6" /><path d="m10 14 6-6 2-3" /><path d="M10 5h12" /><path d="m15 2 5 5" /></svg>
);

export const ServiceIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22a7 7 0 0 0 7-7h-2a5 5 0 0 1-5 5v2z"/><path d="M5 15a7 7 0 0 0 7 7v-2a5 5 0 0 1-5-5H5z"/><path d="M5 9a7 7 0 0 1 7-7v2a5 5 0 0 0-5 5H5z"/><path d="M19 9a7 7 0 0 1-7-7v2a5 5 0 0 0 5 5h2z"/></svg>
);

export const PriceIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="8"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
);

export const WhatsAppIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M16.75 13.96c.25.13.41.2.52.34.11.14.15.43.06.66-.09.23-.29.42-.51.52-.22.1-.56.19-.94.12-.38-.07-1.16-.34-1.84-.91-.68-.57-1.29-1.34-1.79-2.02-.5-.68-.84-1.33-1.02-1.78-.18-.45-.09-.83.12-1.03.21-.2.42-.25.56-.25.14 0 .28 0 .41.02.13.02.29.02.44.41l.23.69c.1.28.11.53.01.76-.1.23-.2.38-.34.51-.14.13-.28.25-.41.38-.13.13-.29.3-.08.56.21.26.96 1.39 2.1 2.22.82.59 1.34.78 1.63.87.29.09.46.06.61-.09Z"/><path d="M12.01 2.01C6.5 2.01 2.02 6.49 2.02 11.99c0 1.74.45 3.48 1.34 5l-1.36 4.94 5.07-1.33c1.45.81 3.09 1.23 4.79 1.23h.01c5.51 0 9.99-4.48 9.99-9.98S17.52 2.01 12.01 2.01ZM12 20.12h-.01c-1.55 0-3.08-.42-4.44-1.23l-.32-.19-3.3 1.02.83-2.99-.21-.34c-.88-1.42-1.34-3.04-1.34-4.73 0-4.54 3.7-8.23 8.24-8.23 4.54 0 8.23 3.69 8.23 8.23 0 4.54-3.69 8.24-8.23 8.24Z"/></svg>
);
